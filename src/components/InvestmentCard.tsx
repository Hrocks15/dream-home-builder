...
export const InvestmentCard = () => {
  return (
    <section className="bg-card border border-border rounded-[2rem] p-6 mb-6" aria-label="Investment overview">
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-3xl font-bold text-success" aria-labelledby="growth-rate-label">+8.3%</p>
        </div>
      </div>
      
      <div className="flex gap-3">
        <Button 
          className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 rounded-2xl h-12 font-semibold"
          aria-label="Start investing now"
        >
        ...
        <Button 
          ...
          aria-label="Begin learning about investing"
        >
