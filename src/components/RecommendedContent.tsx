    ...
    <div className="mb-24">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
        {courses.map((course) => (
          ...
          >
            <div className={`h-40 bg-gradient-to-br ${course.gradient} border border-border`} />
            <div className="bg-card border border-t-0 border-border rounded-b-[2rem] p-5">
              ...
              <Button className="w-full bg-secondary hover:bg-secondary/80 text-foreground rounded-2xl">
                Start Learning
              </Button>
            </div>
          </div>
